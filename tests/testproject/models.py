...
class CustomResource(models.Model):
    created = models.DateTimeField(auto_now=True)
    related_resource_2 = models.ForeignKey(RelatedResource2, null=True, default=None, on_delete=models.CASCADE)
    related_resource_3 = models.ForeignKey(RelatedResource3, on_delete=models.CASCADE)
    name = models.CharField(max_length=255)
